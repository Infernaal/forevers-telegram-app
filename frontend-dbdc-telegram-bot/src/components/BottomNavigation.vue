<template>
  <div>
    ...
    <!-- Bottom Navigation -->
    <div class="fixed bottom-0 left-0 right-0 bg-white rounded-t-4 xs:rounded-t-4 sm:rounded-t-4 ml:rounded-t-5 md:rounded-t-5 lg:max-w-[480px] lg:left-1/2 lg:-translate-x-1/2 lg:rounded-t-5 lg:border-l lg:border-r lg:border-black lg:border-opacity-10 shadow-[0_-4px_16px_rgba(0,0,0,0.08),0_-2px_6px_rgba(0,0,0,0.04)] border-t border-black border-opacity-[0.06] z-50 pb-[env(safe-area-inset-bottom,0px)]">
      <!-- Navigation Items -->
