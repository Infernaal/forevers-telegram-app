      ...
      <div class="flex items-center justify-center p-3 sm:p-4 md:p-5 lg:p-6 pb-[calc(12px+env(safe-area-inset-bottom,0px))] sm:pb-[calc(16px+env(safe-area-inset-bottom,0px))] md:pb-[calc(20px+env(safe-area-inset-bottom,0px))] lg:pb-[calc(24px+env(safe-area-inset-bottom,0px))] min-h-[64px] sm:min-h-[72px] md:min-h-[88px] lg:min-h-[100px]">
        ...
        <div class="flex items-center justify-between w-full gap-2 sm:gap-4 md:gap-6 lg:gap-8 px-2 sm:px-4 md:px-6 lg:px-8">
          ...
          >
            ...
            <span class="text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-medium leading-tight">Profile</span>
          </button>
          ...
          >
            ...
            >
              <svg
                ...
                :class="[
                  ...
                  activeTab === 'wallet'
                    ? 'text-white w-5 h-4 sm:w-6 sm:h-5 md:w-7 md:h-6 lg:w-8 lg:h-7'
                    : 'text-gray-600 w-4 h-3 sm:w-5 sm:h-4 md:w-6 md:h-5 lg:w-7 lg:h-6'
                ]"
              >
            ...
            <span class="text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-medium leading-tight">Wallet</span>
          </button>
            ...
            >
              <svg
                ...
                :class="[
                  'fill-current transition-all duration-200',
                  activeTab === 'favorites'
                    ? 'text-white w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8'
                    : 'text-gray-600 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7'
                ]"
              >
          ...
          >
              ...
              >
                <svg
                  ...
                  :class="[
                    'fill-current transition-all duration-200',
                    activeTab === 'cart'
                      ? 'text-white w-4 h-5 sm:w-5 sm:h-6 md:w-6 md:h-7 lg:w-7 lg:h-8'
                      : 'text-gray-600 w-3 h-4 sm:w-4 sm:h-5 md:w-5 md:h-6 lg:w-6 lg:h-7'
                  ]"
                >
            ...
            <span class="text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-medium leading-tight">Cart</span>
          </button>
          ...
          >
            ...
            >
              <svg
                ...
                :class="[
                  'fill-current transition-all duration-200',
                  activeTab === 'holders'
                    ? 'text-white w-4 h-5 sm:w-5 sm:h-6 md:w-6 md:h-7 lg:w-7 lg:h-8 xl:w-8 xl:h-9'
                    : 'text-gray-600 w-3 h-4 sm:w-4 sm:h-5 md:w-5 md:h-6 lg:w-6 lg:h-7 xl:w-7 xl:h-8'
                ]"
              >
            ...
            <span class="text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-medium leading-tight">Holders</span>
          </button>
        </div>
      </div>
    </div>
