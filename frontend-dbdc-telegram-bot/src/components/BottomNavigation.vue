            ...
            >
              <svg
                ...
                :class="[
                  ...
                  activeTab === 'wallet'
                    ? 'text-white w-5 h-4 sm:w-6 sm:h-5 md:w-7 md:h-6 lg:w-8 lg:h-7 xl:w-9 xl:h-8'
                    : 'text-gray-600 w-4 h-3 sm:w-5 sm:h-4 md:w-6 md:h-5 lg:w-7 lg:h-6 xl:w-8 xl:h-7'
                ]"
              >
            ...
            >
              <svg
                ...
                :class="[
                  'fill-current transition-all duration-200',
                  activeTab === 'favorites'
                    ? 'text-white w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 xl:w-9 xl:h-9'
                    : 'text-gray-600 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8'
                ]"
              >
