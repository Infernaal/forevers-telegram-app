      ...
      <div @click.stop class="relative bg-white rounded-[20px] shadow-xl font-montserrat w-full max-w-[360px] mx-auto p-6">
        ...
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center gap-2">
            <div class="w-7 h-7 bg-[#B3FFB6] border-2 border-[#88EF8C] rounded-full flex items-center justify-center">
            ...
            <h2 class="text-xl font-bold text-[#292727]">Congratulations! Your payment has been successfully processed</h2>
          </div>
