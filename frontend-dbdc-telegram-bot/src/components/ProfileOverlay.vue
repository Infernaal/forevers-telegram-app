  ...
  <div v-if="isVisible" 
    ...
    <div class="flex items-center justify-center min-h-full px-4 py-8"
      ...
      <div class="relative w-full max-w-[375px] bg-gradient-to-br from-[#120B81] via-[#120B81] to-[#09074E] 
                  ...
                  max-h-[calc(100vh-176px)] overflow-hidden"
           @click.stop>
        
        <!-- Menu Items Container -->
        <div class="px-3 pt-8 pb-4 space-y-2">
          
          <!-- Calculator -->
          <div class="flex items-center gap-3 px-3 py-3 hover:bg-white/[0.05] rounded-lg transition-colors cursor-pointer"
        ...
        <div class="px-3 pb-4 space-y-4">
          ...
          <!-- Start Upgrade Card -->
          <div class="relative bg-gradient-to-r from-[#F1E7FF] to-[#F1E7FF] border border-[#DCCCF1] rounded-2xl p-4 overflow-hidden">
            ...
            <div class="absolute left-2 top-3.5">
              <div class="w-8 h-8 rounded-full bg-[#8C4CD1] flex items-center justify-center">
                <svg class="w-4 h-4 text-white" viewBox="0 0 16 16" fill="currentColor">
                  <path d="M8 0L10.472 5.236L16 6.132L12 10.472L12.944 16L8 13.528L3.056 16L4 10.472L0 6.132L5.528 5.236L8 0Z"/>
                </svg>
              </div>
            </div>
            ...
            <div class="relative pl-12">
              <h3 class="text-dbd-dark text-lg font-bold mb-1">Start</h3>
              <p class="text-dbd-gray text-sm">
            ...
            <div class="absolute right-2 top-2">
              <button class="bg-gradient-to-r from-dbd-primary to-[#473FFF] text-white text-sm font-semibold px-6 py-2.5 rounded-full hover:shadow-lg transition-all duration-200"
          ...
          <!-- Bottom ID and Language Section -->
          <div class="flex items-center justify-between gap-4">
            
            <!-- ID Section -->
            <div class="flex items-center gap-2 bg-white/[0.30] backdrop-blur-[32px] border border-white/40 rounded-full px-3 py-2 min-w-0">
              <span class="text-dbd-light-gray text-sm">ID:</span>
              <span class="text-white text-sm font-medium">515745</span>
              <button class="flex-shrink-0 w-6 h-6 bg-white border border-gray-300 rounded-r-full flex items-center justify-center ml-1"
                      @click="copyUserID">
            ...
            <!-- Language Section -->
            <div class="flex items-center gap-2 bg-white/[0.20] border border-white/24 rounded-full px-1.5 py-1.5">
              <!-- US Flag -->
              ...
              <!-- ENG Text -->
              <span class="text-dbd-off-white text-base font-medium px-2">ENG</span>
              
              <!-- Dropdown Arrow -->
              <div class="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center">
                <svg class="w-3 h-3 text-white" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M5.71387 8.57146L9.99958 12.8572L14.2853 8.57146" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/>
                </svg>
              </div>
            </div>
          </div>
...
console.log('ProfileOverlay loaded with new design')
</script>
