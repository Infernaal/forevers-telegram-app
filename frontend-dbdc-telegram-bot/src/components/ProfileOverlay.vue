        ...
        <div class="p-4 sm:p-6 text-white text-center relative h-full flex flex-col">
          ...
          <div class="absolute top-24 sm:top-28 md:top-32 bottom-40 sm:bottom-44 md:bottom-48 left-3 sm:left-4 right-3 sm:right-4
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-center">Calculator</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-center">Settings</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-center">Support</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-center">Help</span>
            </div>
          </div>
...
/* Triangle positioning for all screen sizes */
...
/* Extra small mobile devices (iPhone SE, small Android) - ≤374px */
