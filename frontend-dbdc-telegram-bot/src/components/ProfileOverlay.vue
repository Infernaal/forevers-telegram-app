  ...
  <div v-if="isVisible" class="fixed inset-0 bottom-[88px] z-[9999] font-montserrat bg-black/10 backdrop-blur-xl">
    ...
    <div class="relative w-full h-full flex flex-col justify-center items-center px-4 sm:px-6 md:px-8 lg:px-12">
      ...
      <div class="relative w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl
              ...
              z-[10000]">
        <div class="p-4 sm:p-6 text-white relative h-full flex flex-col">
            <!-- Background -->
          ...
          <!-- Menu Items -->
          <div class="absolute top-24 sm:top-28 md:top-32 bottom-40 sm:bottom-44 md:bottom-48 left-3 sm:left-4 right-3 sm:right-4
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
                        transition-all duration-200 rounded-lg mb-2 mt-2 sm:mt-3
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-left">Calculator</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-left">Ambassador</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-left">Verification</span>
              <!-- Error Badge -->
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-left">Security</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-left">Settings</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-left">Support</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 h-12 sm:h-14 cursor-pointer
              ...
              <span class="text-white text-sm sm:text-base font-bold leading-6 sm:leading-7 flex-1 text-left">Help</span>
            </div>
          </div>
          ...
          <div class="absolute bottom-16 sm:bottom-18 md:bottom-20 left-3 sm:left-4 right-3 sm:right-4 z-[10001]">
            <div class="w-full h-16 sm:h-20 bg-[#F1E7FF] border border-[#DCCCF1] rounded-xl sm:rounded-2xl
              ...
              <div class="relative z-[1]">
                <div class="text-dbd-gray text-xs sm:text-sm font-normal leading-4 sm:leading-6 text-left">
      ...
      <div class="absolute top-full left-4 sm:left-6 -mt-px z-[9998]">
...
/* Bottom sections responsiveness */
@media (max-width: 374px) {
  .absolute.bottom-\\[86px\\] {
    bottom: 68px;
  }
