      ...
      <div class="relative w-full max-w-[375px] bg-gradient-to-br from-[#120B81] via-[#120B81] to-[#09074E] 
        ...
        <div class="flex-shrink-0 px-3 pb-3 space-y-3">
          ...
          <div class="flex items-center justify-between gap-3">
            ...
            <!-- ID Section -->
            <div class="flex items-center bg-white/[0.30] backdrop-blur-[32px] border border-white/40 rounded-full pl-3 pr-1 py-2 min-w-0">
            ...
            <!-- Language Section -->
            <div class="flex items-center gap-2 bg-white/[0.20] border border-white/24 rounded-full px-1.5 py-1.5 cursor-pointer hover:bg-white/25 transition-colors"
              ...
              <!-- ENG Text -->
              <span class="text-dbd-off-white text-base font-medium px-1">ENG</span>
