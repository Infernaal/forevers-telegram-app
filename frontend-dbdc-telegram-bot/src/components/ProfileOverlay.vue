              ...
              <div class="flex-1 flex flex-col gap-1.5 xs:gap-2 sm:gap-2.5 px-1 xs:px-1.5 sm:px-2 min-w-0 overflow-hidden">
                ...
                <div class="flex items-center justify-start gap-1.5 xs:gap-2 sm:gap-2.5
                  ...
                  <span class="text-dbd-off-white text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl
                               font-semibold leading-tight xs:leading-snug sm:leading-normal
          ...
          <div class="flex-1 flex flex-col z-[1]
            ...
            <div class="flex items-center
              ...
              <div class="w-10 xs:w-11 sm:w-12 md:w-13 h-10 xs:h-11 sm:h-12 md:h-13
                ...
                <svg class="w-5 xs:w-6 sm:w-6 md:w-7 h-5 xs:h-6 sm:h-6 md:h-7" viewBox="0 0 16 20" fill="none">
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-6 xs:leading-7 sm:leading-8 flex-1 text-left">Calculator</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-6 xs:leading-7 sm:leading-8 flex-1 text-left">Ambassador</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-6 xs:leading-7 sm:leading-8 flex-1 text-left">Security</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-6 xs:leading-7 sm:leading-8 flex-1 text-left">Settings</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-6 xs:leading-7 sm:leading-8 flex-1 text-left">Support</span>
            </div>
            ...
            <div class="w-[110px] xs:w-[120px] sm:w-[130px] md:w-[140px] lg:w-[150px] xl:w-[160px]
              ...
              <button v-if="!showCopySuccess"
                      class="absolute right-0 top-0 bottom-0 m-0
                            w-6 xs:w-7 sm:w-8 md:w-9 lg:w-10 xl:w-11
                            min-w-[24px] xs:min-w-[28px] sm:min-w-[32px] md:min-w-[36px] lg:min-w-[40px] xl:min-w-[44px]
                ...
                <svg class="w-3 xs:w-4 sm:w-5 md:w-6 lg:w-7 xl:w-8
                           h-3 xs:h-4 sm:h-5 md:h-6 lg:h-7 xl:h-8" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
