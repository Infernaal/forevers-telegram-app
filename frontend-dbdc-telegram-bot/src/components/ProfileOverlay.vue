        ...
        <div class="mb-4">
                ...
                <div class="flex items-center gap-2
                  ...
                  <div class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0">
                    <svg class="w-full h-full" viewBox="0 0 24 24" fill="none">
                      ...
                      <path d="M12 2l2.4 7.2h7.6l-6 4.8 2.4 7.2L12 17.2l-6 4.8 2.4-7.2-6-4.8h7.6L12 2z"
                            fill="#F3F4F6"/>
                    </svg>
                  </div>
          ...
          <div class="flex-1 overflow-y-auto mb-4">
            ...
            <div class="menu-item"
              ...
              <div class="menu-icon">
                <svg class="w-5 h-5 text-white" viewBox="0 0 18 22" fill="currentColor">
            ...
            <div class="menu-item"
              ...
              <div class="menu-icon">
                <svg class="w-5 h-5 text-white" viewBox="0 0 18 20" fill="currentColor">
            ...
            <div class="flex-1 max-w-[140px] xs:max-w-[150px] sm:max-w-[160px] h-full
              ...
              <button v-if="!showCopySuccess"
                      class="absolute right-0 top-0 bottom-0
                             ...
                             active:scale-95"
                      @click="copyUserID">
                <svg class="w-5 h-5 sm:w-6 sm:h-6 text-dbd-primary" viewBox="0 0 20 20" fill="none">
