        ...
        <div class="py-4 px-4 sm:px-6 md:px-6 lg:px-8 xl:px-10 text-white flex flex-col relative z-10 h-full">
          ...
          <div class="flex-1 flex flex-col z-[1]
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 lg:leading-7 flex-1 text-left">Calculator</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 lg:leading-7 flex-1 text-left">Ambassador</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 lg:leading-7 flex-1 text-left">Verification</span>
              <!-- Error Badge -->
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 lg:leading-7 flex-1 text-left">Security</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 lg:leading-7 flex-1 text-left">Settings</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 lg:leading-7 flex-1 text-left">Support</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 lg:leading-7 flex-1 text-left">Help</span>
            </div>
          </div>

          <!-- Start Section -->
          <div class="relative flex-shrink-0 z-[1] mb-3 sm:mb-4 md:mb-4 lg:mb-4">
            <div class="w-full
