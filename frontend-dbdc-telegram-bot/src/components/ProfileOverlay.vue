        ...
        <div class="p-2 xs:p-3 sm:p-4 md:p-5 lg:p-6 text-white text-center">
          ...
          <div class="absolute
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1 text-left">Calculator</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1 text-left">Ambassador</span>
            </div>
