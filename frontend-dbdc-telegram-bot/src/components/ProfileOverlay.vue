            ...
            <div class="w-[115px] xs:w-[125px] sm:w-[135px] md:w-[145px] lg:w-[150px]
              ...
              <button v-if="!showCopySuccess"
                      class="absolute right-0 top-0 bottom-0 m-0
                            w-7 xs:w-8 sm:w-9 md:w-10
                            min-w-[28px] xs:min-w-[32px] sm:min-w-[36px] md:min-w-[40px] lg:min-w-[48px]
                ...
                <svg class="w-5 xs:w-6 sm:w-6 md:w-7 h-5 xs:h-6 sm:h-6 md:h-7" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
