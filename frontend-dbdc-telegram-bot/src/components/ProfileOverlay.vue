        ...
        <div class="p-2 xs:p-3 sm:p-4 md:p-5 lg:p-6 text-white text-center">
            ...
            <div class="w-full
              ...
              <div class="flex-shrink-0">
                <img src="https://images.pexels.com/photos/15023413/pexels-photo-15023413.jpeg?auto=compress&cs=tinysrgb&w=400"
                    alt="Jason Williams"
                    class="w-16 xs:w-18 sm:w-20 md:w-22 lg:w-24
              ...
              <div class="flex-1 flex flex-col gap-1 xs:gap-1.5 sm:gap-2 px-0.5 xs:px-1 sm:px-1.5 min-w-0 overflow-hidden">
                ...
                <div class="flex items-center gap-1 xs:gap-1.5 sm:gap-2
                  ...
                  <div class="w-5 xs:w-6 sm:w-7 md:w-8 h-5 xs:h-6 sm:h-7 md:h-8 flex-shrink-0">
                ...
                <!-- User Name -->
                <h2 class="text-white text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-4 xs:leading-5 sm:leading-6 m-0 whitespace-nowrap overflow-hidden text-ellipsis">
                  Jason Williams
                </h2>
              </div>
          ...
          <div class="absolute
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Calculator</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Ambassador</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Verification</span>
              <!-- Error Badge -->
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Security</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Settings</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Support</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Help</span>
            </div>
          </div>
          ...
          <div class="absolute
            ...
            <div class="w-full
              ...
              <div class="relative z-[1] w-full">
                <div class="text-dbd-gray text-xs xs:text-sm sm:text-base font-normal leading-4 xs:leading-5 sm:leading-6 text-left">
          ...
          <div class="absolute
            ...
            <div class="w-[110px] xs:w-[120px] sm:w-[130px] md:w-[140px] lg:w-[145px]
              ...
              <button v-if="!showCopySuccess"
                      class="w-6 xs:w-7 sm:w-8 md:w-9 h-6 xs:h-7 sm:h-8 md:h-9
                            ...
                            active:scale-98"
                      @click="copyUserID">
                <svg class="w-4 xs:w-5 sm:w-5 md:w-6 h-4 xs:h-5 sm:h-5 md:h-6" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="w-[100px] xs:w-[110px] sm:w-[120px] md:w-[125px] lg:w-[131px]
              ...
              <div v-if="showLanguageDropdown"
                  class="absolute bottom-[40px] xs:bottom-[45px] sm:bottom-[50px] left-0 right-0 z-[1000] animate-[dropdownSlideUp_0.2s_ease-out]">
                <div class="bg-gradient-to-r from-[#120B81] via-[#09074E] to-[#09074E]
                  ...
                  <div v-for="(language, index) in languages"
                    ...
                    <CountryFlag :country="language.country" size="small"
                                 class="flex-shrink-0 !w-4 xs:!w-5 sm:!w-6
                                        !h-4 xs:!h-5 sm:!h-6
                                        !min-w-4 xs:!min-w-5 sm:!min-w-6
                                        !min-h-4 xs:!min-h-5 sm:!min-h-6" />
                    <span class="text-dbd-off-white text-xs xs:text-sm sm:text-base font-medium
