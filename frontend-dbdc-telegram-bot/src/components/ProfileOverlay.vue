...
@media (max-width: 320px) {
  ...
  .fixed.inset-0.z-50 .absolute:first-child {
    left: 1rem !important;
    bottom: 75px !important;
  }
}

/* Small phones - 321px to 374px */
...
/* Small tablets (portrait) - 480px to 639px */
...
/* Tablets (portrait) - 640px to 767px */
...
/* Small tablets (landscape) - 768px to 1023px */
...
/* Large tablets - 1024px to 1279px */
