<template>
  <div v-if="isVisible" class="profile-overlay fixed inset-0 z-50 font-montserrat bg-black bg-opacity-10 backdrop-blur-xl">
    <!-- Dropdown Wrapper -->
    <div class="relative w-full h-full flex justify-center items-center
      ...
      <!-- Dropdown Menu -->
      <div class="profile-dropdown relative w-full
        ...
        <div class="p-2 xs:p-3 sm:p-4 md:p-5 lg:p-6 text-white text-center">
          ...
          <div class="profile-header absolute top-2 xs:top-2.5 sm:top-3 md:top-3.5 lg:top-4
            ...
            <div class="w-full
              ...
              <div class="flex-shrink-0">
                <img src="https://images.pexels.com/photos/15023413/pexels-photo-15023413.jpeg?auto=compress&cs=tinysrgb&w=400"
                    alt="Jason Williams"
                    class="profile-avatar w-16 xs:w-18 sm:w-20 md:w-22 lg:w-24
                            h-16 xs:h-18 sm:h-20 md:h-22 lg:h-24
              ...
              <div class="flex-1 flex flex-col gap-1 xs:gap-1.5 sm:gap-2 px-0.5 xs:px-1 sm:px-1.5 min-w-0 overflow-hidden">
                <!-- Silver Badge -->
                <div class="badge flex items-center gap-1 xs:gap-1.5 sm:gap-2
                  ...
                  <div class="badge-icon w-5 xs:w-6 sm:w-7 md:w-8 h-5 xs:h-6 sm:h-7 md:h-8 flex-shrink-0">
                  ...
                  <span class="badge-text text-dbd-off-white text-xs xs:text-sm sm:text-base font-medium leading-4 xs:leading-5 sm:leading-6">Silver</span>
                </div>

                <!-- User Name -->
                <h2 class="profile-name text-white text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-4 xs:leading-5 sm:leading-6 m-0 whitespace-nowrap overflow-hidden text-ellipsis">
                  Jason Williams
                </h2>
              </div>

              <!-- Arrow Button -->
              <button class="arrow-button w-9 xs:w-10 sm:w-11 md:w-12 h-9 xs:h-10 sm:h-11 md:h-12
                            ...
                            flex-shrink-0"
                      @click="$emit('close')">
                <svg class="arrow-icon w-5 xs:w-6 sm:w-6 md:w-7 h-5 xs:h-6 sm:h-6 md:h-7" viewBox="0 0 24 24" fill="none">
          ...
          <div class="menu-items absolute
            ...
            <div class="menu-item flex items-center
                        ...
                        mb-1.5 xs:mb-2 sm:mb-2.5 mt-2 xs:mt-2.5 sm:mt-3
                        hover:bg-white hover:bg-opacity-10 hover:translate-x-1 relative"
                @click="handleMenuClick('calculator')">
              <div class="menu-icon w-8 xs:w-9 sm:w-10 md:w-11 h-8 xs:h-9 sm:h-10 md:h-11
                          bg-[#3A33D3] border border-white border-opacity-20
                          rounded-full flex items-center justify-center flex-shrink-0">
                <svg class="w-4 xs:w-5 sm:w-5 md:w-6 h-4 xs:h-5 sm:h-5 md:h-6" viewBox="0 0 16 20" fill="none">
              ...
              <span class="menu-text text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Calculator</span>
            </div>
            ...
            <div class="menu-item flex items-center
              ...
              <span class="menu-text text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Ambassador</span>
            </div>
            ...
            <div class="menu-item flex items-center
              ...
              <span class="menu-text text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Verification</span>
              <!-- Error Badge -->
            ...
            <div class="menu-item flex items-center
              ...
              <span class="menu-text text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Security</span>
            </div>
            ...
            <div class="menu-item flex items-center
              ...
              <span class="menu-text text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Settings</span>
            </div>
            ...
            <div class="menu-item flex items-center
              ...
              <span class="menu-text text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Support</span>
            </div>
            ...
            <div class="menu-item flex items-center
              ...
              <span class="menu-text text-white text-sm xs:text-base sm:text-lg font-bold leading-5 xs:leading-6 sm:leading-7 flex-1">Help</span>
            </div>
          </div>

          <!-- Start Section -->
          <div class="start-section absolute
            ...
            <div class="w-full
              ...
              <div class="start-content flex items-center mb-0.5 xs:mb-1 sm:mb-1.5 relative z-[1]">
                <div class="flex items-center gap-2 xs:gap-2.5 sm:gap-3 md:gap-3.5 flex-1">
                  <div class="flex-shrink-0">
                    <svg class="start-icon w-6 xs:w-7 sm:w-8 md:w-9 lg:w-10 h-6 xs:h-7 sm:h-8 md:h-9 lg:h-10" viewBox="0 0 32 32" fill="none">
                  ...
                  <div class="start-title text-dbd-dark text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-4 xs:leading-5 sm:leading-6 mb-0.5 xs:mb-1">Start</div>
                </div>
                <button class="upgrade-button relative z-[1]
              ...
              <div class="relative z-[1] w-full">
                <div class="start-description text-dbd-gray text-xs xs:text-sm sm:text-base font-normal leading-4 xs:leading-5 sm:leading-6 text-left">
          ...
          <!-- Bottom Controls -->
          <div class="bottom-controls absolute
            ...
            <!-- ID Section -->
            <div class="id-section w-[110px] xs:w-[120px] sm:w-[130px] md:w-[140px] lg:w-[145px]
                        h-8 xs:h-9 sm:h-10 md:h-11 lg:h-12
              ...
              <div v-if="!showCopySuccess" class="id-text flex items-center gap-0.5 pl-2 xs:pl-2.5 sm:pl-3 pr-8 xs:pr-9 sm:pr-10 flex-1">
              ...
              <button v-if="!showCopySuccess"
                      class="copy-button w-6 xs:w-7 sm:w-8 md:w-9 h-6 xs:h-7 sm:h-8 md:h-9
                            ...
                            active:scale-98"
                      @click="copyUserID">
                <svg class="copy-icon w-4 xs:w-5 sm:w-5 md:w-6 h-4 xs:h-5 sm:h-5 md:h-6" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Language Section -->
            <div class="language-section w-[100px] xs:w-[110px] sm:w-[120px] md:w-[125px] lg:w-[131px]
                        h-8 xs:h-9 sm:h-10 md:h-11 lg:h-12
              ...
              <div class="language-content flex items-center gap-1 xs:gap-1.5 sm:gap-2 flex-1 min-w-0 pr-4 xs:pr-5 sm:pr-6">
                <CountryFlag :country="selectedLanguage.country" size="medium"
                             class="language-flag flex-shrink-0 !w-5 xs:!w-6 sm:!w-7 md:!w-8
                                    !h-5 xs:!h-6 sm:!h-7 md:!h-8
                                    !min-w-5 xs:!min-w-6 sm:!min-w-7 md:!min-w-8
                                    !min-h-5 xs:!min-h-6 sm:!min-h-7 md:!min-h-8" />
                <span class="language-code text-dbd-off-white text-xs xs:text-sm sm:text-base md:text-lg font-normal
              ...
              <div class="dropdown-arrow w-4 xs:w-5 sm:w-5 h-4 xs:h-5 sm:h-5 flex items-center justify-center flex-shrink-0
              ...
              <div v-if="showLanguageDropdown"
                  class="language-dropdown absolute bottom-[40px] xs:bottom-[45px] sm:bottom-[50px] left-0 right-0 z-[1000] animate-[dropdownSlideUp_0.2s_ease-out]">
                <div class="bg-gradient-to-r from-[#120B81] via-[#09074E] to-[#09074E]
                            ...
                            max-h-[120px] xs:max-h-[130px] sm:max-h-[140px]
                            overflow-y-auto scrollbar-none shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                  <div v-for="(language, index) in languages"
                      :key="language.code"
                      class="language-item flex items-center
                              gap-1.5 xs:gap-2 sm:gap-2.5
                              px-2 xs:px-2.5 sm:px-3
                              py-1 xs:py-1.5 sm:py-2
                              rounded-md xs:rounded-lg sm:rounded-xl
                              cursor-pointer transition-all duration-200
                              min-h-7 xs:min-h-8 sm:min-h-9
                    ...
                    <CountryFlag :country="language.country" size="small"
                                 class="language-item-flag flex-shrink-0 !w-4 xs:!w-5 sm:!w-6
                                        !h-4 xs:!h-5 sm:!h-6
                                        !min-w-4 xs:!min-w-5 sm:!min-w-6
                                        !min-h-4 xs:!min-h-5 sm:!min-h-6" />
                    <span class="language-item-text text-dbd-off-white text-xs xs:text-sm sm:text-base font-medium
                                leading-4 xs:leading-5 sm:leading-6
                                flex-1 mr-4 xs:mr-5 sm:mr-6">
                      {{ language.code }}
                    </span>
                    <svg v-if="language.code === selectedLanguage.code"
                        class="absolute right-2 xs:right-2.5 sm:right-3 top-1/2 transform -translate-y-1/2 flex-shrink-0"
...
/* Regular mobile devices (375px to 430px) */
