<template>
  <div v-if="isVisible" class="fixed inset-0 z-50 font-montserrat bg-black bg-opacity-10 backdrop-blur-xl">
    <!-- Dropdown Wrapper -->
    <div class="relative w-full flex justify-center items-start mt-56 sm:mt-60 md:mt-20 lg:mt-16 xl:mt-12">
      <!-- Dropdown Menu -->
      ...
      <div class="absolute top-full mt-10 sm:mt-10 md:mt-6 lg:mt-6 xl:mt-6 left-[11%] sm:left-[13%] md:left-[15%] lg:left-[17%] z-[60]">
