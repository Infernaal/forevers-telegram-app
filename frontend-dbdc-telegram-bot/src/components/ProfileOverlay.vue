<template>
  <div v-if="isVisible" class="fixed inset-0 z-50 font-montserrat bg-black bg-opacity-10 backdrop-blur-xl">
    ...
    <div class="absolute 
                ...
                bottom-[82px] sm:bottom-[90px] md:bottom-[300px] lg:bottom-[153px] xl:bottom-[170px]
    ...
    <div class="absolute 
                ...
                bottom-[92px] sm:bottom-[140px] md:bottom-[110px] lg:bottom-[163px] xl:bottom-[180px]
                h-[520px] sm:h-[520px] md:h-[580px] lg:h-[500px] xl:h-[450px]
