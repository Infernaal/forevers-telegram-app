<template>
  <div v-if="isVisible" class="fixed inset-0 z-50 font-montserrat bg-black bg-opacity-10 backdrop-blur-xl">
    <!-- Dropdown Wrapper -->
    <div class="relative w-full flex justify-center items-end pb-55 sm:pb-52 md:pb-28 lg:pb-32 xl:pb-36">
      <!-- Dropdown Menu -->
      ...
      <div class="absolute top-full mt-4 left-[11%] sm:left-[13%] md:left-[15%] lg:left-[17%] z-[60]">
