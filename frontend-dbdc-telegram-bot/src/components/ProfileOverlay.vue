          ...
          <div class="flex items-center justify-center h-11 relative">
            ...
            <div class="relative flex items-center">
              <div class="bg-white/[0.30] backdrop-blur-[32px] border border-white/40 rounded-full h-11 w-36 sm:w-40 md:w-44 flex items-center justify-between pl-3 pr-0">
                ...
                <button class="flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-white border border-[#D8D8D8] rounded-r-full flex items-center justify-center hover:bg-gray-50 transition-colors"
                        @click="copyUserID">
                  <svg class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-gray-600" viewBox="0 0 24 24" fill="currentColor">
