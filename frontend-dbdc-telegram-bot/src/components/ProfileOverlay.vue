<template>
  <div v-if="isVisible" class="fixed inset-0 z-50 font-montserrat bg-black bg-opacity-10 backdrop-blur-xl">
    <!-- Triangle Pointer -->
    <div class="absolute left-8 lg:left-9 bottom-[110px] sm:bottom-[105px] md:bottom-[120px] lg:bottom-[100px] xl:bottom-[95px] z-[65] 
    ...
    <div class="absolute left-2 right-2 bottom-[110px] sm:bottom-[115px] md:bottom-[130px] lg:bottom-[110px] xl:bottom-[105px]
                h-[580px] sm:h-[560px] md:h-[580px] lg:h-[500px] xl:h-[450px]
                max-h-[calc(100vh-130px)] sm:max-h-[calc(100vh-120px)] md:max-h-[calc(100vh-135px)] lg:max-h-[calc(100vh-130px)] xl:max-h-[calc(100vh-130px)]
