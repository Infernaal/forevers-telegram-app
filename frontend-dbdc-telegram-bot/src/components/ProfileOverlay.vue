<template>
  <div v-if="isVisible" class="fixed inset-0 z-50 font-montserrat bg-black bg-opacity-10 backdrop-blur-xl">
    ...
    <div class="absolute
                ...
                bottom-[82px] sm:bottom-[130px] md:bottom-[150px] lg:bottom-[153px] xl:bottom-[175px]
    ...
    <div class="absolute
                ...
                bottom-[92px] sm:bottom-[140px] md:bottom-[290px] lg:bottom-[163px] xl:bottom-[160px]
