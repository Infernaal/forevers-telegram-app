<template>
  <div v-if="isVisible" class="fixed inset-0 z-[9999] font-montserrat bg-black/10 backdrop-blur-xl min-h-screen">
   ...
   min-h-[calc(100vh-120px)] sm:min-h-[calc(100vh-130px)] md:min-h-[calc(100vh-140px)]
   lg:min-h-[calc(100vh-148px)] xl:min-h-[calc(100vh-150px)]
   pb-[88px] sm:pb-[96px] md:pb-[104px] lg:pb-[110px] xl:pb-[114px]
        ...
        <div class="py-4 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 text-white flex flex-col relative z-10">
          ...
          <div class="relative flex-shrink-0 z-[1] mb-3 sm:mb-4 md:mb-5">
            <div class="w-full
              ...
              <div class="mt-2 sm:mt-2.5 md:mt-3 relative z-[1]">
                <div class="text-dbd-gray text-xs sm:text-sm md:text-base font-normal">
