        ...
        <div class="py-4 px-4 sm:px-6 md:px-6 lg:px-8 xl:px-10 text-white flex flex-col relative z-10 h-full">
          ...
          <div class="relative flex-shrink-0 z-[2] mb-3 sm:mb-4 md:mb-3 lg:mb-3">
            <div class="w-full
                        ...
                        rounded-[50px_12px_12px_50px] xs:rounded-[55px_14px_14px_55px] sm:rounded-[60px_16px_16px_60px] md:rounded-[60px_16px_16px_60px] lg:rounded-[70px_18px_18px_70px] xl:rounded-[80px_20px_20px_80px]
                        flex items-center p-1.5 xs:p-2 sm:p-2.5 md:p-2.5 lg:p-3 xl:p-4 gap-2 xs:gap-2.5 sm:gap-3 md:gap-3 lg:gap-4 xl:gap-5 overflow-hidden
          ...
          <div class="flex-1 flex flex-col z-[1]
            ...
            <div class="flex items-center
                        gap-1.5 xs:gap-2 sm:gap-2.5 md:gap-2.5 lg:gap-3
                        px-2 xs:px-3 sm:px-4 md:px-4 lg:px-5
              ...
              <div class="w-8 xs:w-9 sm:w-10 md:w-10 lg:w-11 h-8 xs:h-9 sm:h-10 md:h-10 lg:h-11
                          bg-[#3A33D3] border border-white border-opacity-30
                          rounded-full flex items-center justify-center flex-shrink-0
                          transition-all duration-300 hover:bg-[#4A43E3] hover:scale-110">
                <svg class="w-4 xs:w-5 sm:w-6 md:w-6 lg:w-7 h-4 xs:h-5 sm:h-6 md:h-6 lg:h-7" viewBox="0 0 16 20" fill="none">
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 flex-1 text-left">Calculator</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <div class="w-8 xs:w-9 sm:w-10 md:w-10 lg:w-11 h-8 xs:h-9 sm:h-10 md:h-10 lg:h-11
                          ...
                          rounded-full flex items-center justify-center flex-shrink-0
                          transition-all duration-300 hover:bg-[#4A43E3] hover:scale-110">
                <svg class="w-4 xs:w-5 sm:w-6 md:w-6 lg:w-7 h-4 xs:h-5 sm:h-6 md:h-6 lg:h-7" viewBox="0 0 14 20" fill="none">
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 flex-1 text-left">Ambassador</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <div class="w-8 xs:w-9 sm:w-10 md:w-10 lg:w-11 h-8 xs:h-9 sm:h-10 md:h-10 lg:h-11
                          ...
                          rounded-full flex items-center justify-center flex-shrink-0
                          transition-all duration-300 hover:bg-[#4A43E3] hover:scale-110">
                <svg class="w-4 xs:w-5 sm:w-6 md:w-6 lg:w-7 h-4 xs:h-5 sm:h-6 md:h-6 lg:h-7" viewBox="0 0 18 22" fill="none">
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 flex-1 text-left">Verification</span>
              <!-- Error Badge -->
            ...
            <div class="flex items-center
              ...
              <div class="w-8 xs:w-9 sm:w-10 md:w-10 lg:w-11 h-8 xs:h-9 sm:h-10 md:h-10 lg:h-11
                          ...
                          rounded-full flex items-center justify-center flex-shrink-0
                          transition-all duration-300 hover:bg-[#4A43E3] hover:scale-110">
                <svg class="w-4 xs:w-5 sm:w-6 md:w-6 lg:w-7 h-4 xs:h-5 sm:h-6 md:h-6 lg:h-7" viewBox="0 0 18 20" fill="none">
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 flex-1 text-left">Security</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <div class="w-8 xs:w-9 sm:w-10 md:w-10 lg:w-11 h-8 xs:h-9 sm:h-10 md:h-10 lg:h-11
                          ...
                          rounded-full flex items-center justify-center flex-shrink-0
                          transition-all duration-300 hover:bg-[#4A43E3] hover:scale-110">
                <svg class="w-4 xs:w-5 sm:w-6 md:w-6 lg:w-7 h-4 xs:h-5 sm:h-6 md:h-6 lg:h-7" viewBox="0 0 20 20" fill="none">
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 flex-1 text-left">Settings</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 flex-1 text-left">Support</span>
            </div>
            ...
            <div class="flex items-center
              ...
              <span class="text-white text-xs xs:text-sm sm:text-base md:text-base lg:text-lg font-bold leading-4 xs:leading-5 sm:leading-6 md:leading-6 flex-1 text-left">Help</span>
            </div>
          </div>
          ...
          <div class="relative flex-shrink-0 z-[1] mb-3 sm:mb-4 md:mb-3 lg:mb-3">
            <div class="w-full
              ...
              rounded-2xl
              px-4 py-3 sm:px-5 sm:py-4 md:px-5 md:py-4 lg:px-5 lg:py-4
              ...
              <div class="flex items-center justify-between relative z-[1] w-full gap-3 sm:gap-4">
                <div class="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                  <div class="flex-shrink-0 w-6 sm:w-7 md:w-7 lg:w-8 h-6 sm:h-7 md:h-7 lg:h-8">
          ...
          <!-- Bottom Controls -->
          <div class="relative flex-shrink-0 z-[1] flex justify-center items-center gap-3 sm:gap-4 md:gap-4 lg:gap-5 h-10 sm:h-11 md:h-11 lg:h-12 mb-2">
