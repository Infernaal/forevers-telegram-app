<template>
  <div v-if="isVisible" class="fixed inset-0 z-50 font-montserrat bg-black bg-opacity-10 backdrop-blur-xl">
    ...
    <div class="absolute 
                ...
                bottom-[82px] sm:bottom-[90px] md:bottom-[300px] lg:bottom-[180px] xl:bottom-[170px]
    ...
    <div class="absolute 
                ...
                bottom-[120px] sm:bottom-[140px] md:bottom-[360px] lg:bottom-[190px] xl:bottom-[180px]
