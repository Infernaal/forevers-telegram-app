<template>
  <div class="w-full min-h-screen bg-gray-100 font-montserrat overflow-y-auto overflow-x-hidden">
    ...
    <div class="w-full min-h-screen bg-gray-100 relative px-4 pt-5 pb-32 sm:pb-36 md:pb-40 lg:pb-44">
      ...
      <!-- Decorative F Icons -->
      <!-- Top left -->
      <svg class="absolute top-3 left-3 w-20 h-20 opacity-30 rotate-[25deg]" viewBox="0 0 120 131" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.6">
      ...
      <!-- Top right -->
      <svg class="absolute top-6 right-4 w-16 h-16 opacity-35 -rotate-12" viewBox="0 0 120 131" fill="none" xmlns="http://www.w3.org/2000/svg">
        <use href="#clip0" />
      </svg>

      <!-- Bottom left -->
      <svg class="absolute bottom-6 left-4 w-24 h-24 opacity-25 rotate-[45deg]" viewBox="0 0 120 131" fill="none" xmlns="http://www.w3.org/2000/svg">
        <use href="#clip0" />
      </svg>

      <!-- Bottom right -->
      <svg class="absolute bottom-3 right-3 w-20 h-20 opacity-25 rotate-[-30deg]" viewBox="0 0 120 131" fill="none" xmlns="http://www.w3.org/2000/svg">
        <use href="#clip0" />
      </svg>
