<template>
  <div class="w-full min-h-screen bg-gray-100 font-montserrat overflow-y-auto overflow-x-hidden">
    ...
    <div class="w-full min-h-screen bg-gray-100 relative px-4 pt-5 pb-20">
      ...
      <!-- Unified Steps Block -->
      <div class="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl mx-auto mb-12 px-4 sm:px-6 md:px-8">
        <div class="grid grid-cols-3 gap-x-4 sm:gap-x-6 md:gap-x-8 items-start">
          ...
          <div class="flex flex-col items-center gap-2">
            ...
            <div class="flex flex-col items-center gap-1 text-center">
              <div class="flex items-center gap-1.5 justify-center">
                <svg width="16" height="16" fill="none" viewBox="0 0 24 24"><path d="M18 16.08..." fill="#7E7E7E"/></svg>
                <span class="text-dbd-gray text-sm font-medium">1</span>
              </div>
          ...
          <div class="flex flex-col items-center gap-2 relative">
            ...
            <div class="absolute left-[-50%] top-1/2 h-px w-full bg-dbd-light-gray -z-10"></div>

            <!-- Indicator -->
            <div class="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-r-full bg-dbd-primary z-10"></div>

            <!-- Description -->
            <div class="flex flex-col items-center gap-1 text-center">
              <div class="flex items-center gap-1.5 justify-center">
                <svg width="14" height="14" fill="none" viewBox="0 0 24 24"><path d="M12 2..." fill="#7E7E7E"/></svg>
          ...
          <div class="flex flex-col items-center gap-2 relative">
            ...
            <div class="flex flex-col items-center gap-1 text-center">
              <div class="flex items-center gap-1.5 justify-center">
                <svg width="14" height="14" fill="none" viewBox="0 0 24 24"><path d="M12 2L..." fill="#7E7E7E"/></svg>
