          ...
          <div class="web-link-content">
            ...
            <div class="copy-link-container">
              ...
              <button
                ...
                @click="copyWebLink"
              >
                <span v-if="!linkCopied" class="copy-button-text">Copy</span>
                <span v-else class="copy-button-text-copied">Copied</span>
                <div class="copy-icon">
                  <svg v-if="!linkCopied" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div v-else class="copy-tick-container">
