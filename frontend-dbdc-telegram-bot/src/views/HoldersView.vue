<template>
  <div class="w-full min-h-screen bg-gray-100 font-montserrat overflow-y-auto overflow-x-hidden">
    ...
    <div class="w-full min-h-screen bg-gray-100 relative px-4 pt-5 pb-32 sm:pb-36 md:pb-40 lg:pb-44">
      ...
      <!-- QR Code Section -->
      <div class="relative overflow-visible w-full px-4 sm:px-6 md:px-8 xl:px-12 h-[24rem] sm:h-[26rem] md:h-[28rem] xl:h-[30rem] mb-6 sm:mb-8">
        ...
        <div class="absolute inset-0 rounded-3xl bg-gradient-to-r from-blue-900 via-indigo-900 to-blue-800 backdrop-blur-lg overflow-hidden">
          ...
          <!-- F_Icon 1 - Top left -->
          <svg class="absolute w-[14vw] max-w-[64px] sm:max-w-[72px] h-auto opacity-20 rotate-[46.8deg] -left-2 top-4" viewBox="0 0 120 131" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g opacity="1">
          ...
          <!-- F_Icon 5 - Top right -->
          <svg class="absolute w-[14vw] max-w-[64px] sm:max-w-[72px] h-auto rotate-[121.978deg] -right-2 top-5 opacity-20" viewBox="0 0 133 134" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g opacity="1">
          ...
          <svg class="absolute w-[20vw] max-w-[96px] sm:max-w-[112px] h-auto opacity-30 rotate-[-31.597deg] right-0 bottom-[9rem] sm:bottom-[10rem] md:bottom-[11rem]" viewBox="0 0 155 177" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g opacity="1">
          ...
          <svg class="absolute left-[-1.75rem] top-[11rem] sm:top-[12rem] w-[24vw] max-w-[120px] h-auto opacity-30 -rotate-12" viewBox="0 0 155 177" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g opacity="1">
