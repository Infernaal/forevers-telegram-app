<template>
  <div class="rent-out-transaction-view w-full max-w-md lg:max-w-6xl xl:max-w-7xl mx-auto bg-gray-100 min-h-screen relative">
    ...
    <div v-if="showTransactionModal" class="transaction-details-modal fixed inset-0 z-50 flex items-end lg:items-center justify-center bg-black bg-opacity-20 backdrop-blur-sm">
      <div class="w-full max-w-md md:max-w-none lg:max-w-lg xl:max-w-xl bg-white rounded-t-3xl md:rounded-t-3xl lg:rounded-3xl xl:rounded-4xl shadow-xl animate-slide-up md:animate-slide-up lg:animate-none">
        <!-- Modal Header -->
