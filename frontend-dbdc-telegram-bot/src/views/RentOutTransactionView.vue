          ...
          <div v-if="showExportMenu" class="absolute right-0 top-full mt-2 z-50">
            ...
            <div class="dropdown-container">
              ...
              <div class="dropdown-content">
                <!-- CSV Option -->
                <button @click="exportData('csv')" class="dropdown-option">
                  <div class="dropdown-option-bg"></div>
                  <div class="dropdown-option-content">
                    ...
                    <span class="dropdown-text">CSV</span>
                  </div>
                </button>

                <!-- PDF Option -->
                <button @click="exportData('pdf')" class="dropdown-option">
                  <div class="dropdown-option-bg"></div>
                  <div class="dropdown-option-content">
                    <div class="dropdown-icon-container">
