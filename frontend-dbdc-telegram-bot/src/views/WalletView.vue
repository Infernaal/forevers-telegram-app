...
<template>
  <div class="wallet-view w-full min-h-screen bg-white font-montserrat">
    <!-- Content Container -->
    <div class="content-container px-4 pt-6 pb-32 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        ...
        <div class="bg-white rounded-2xl p-5 border border-gray-200 shadow-md">
          <div class="flex flex-col sm:flex-row sm:justify-between items-center gap-4">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-2xl font-bold text-[#2019CE]">10,196</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="bg-white rounded-2xl p-5 border border-gray-200 shadow-md">
          ...
          <div class="flex items-center space-x-3 mb-4">
            <div class="w-6 h-6">
              <svg width="21" height="21" viewBox="0 0 22 22" fill="none">
                <g clip-path="url(#clip0_2_23137)">
                  <path d="M10.8717 21.4348C10.6085 ..." fill="#2019CE"/>
                </g>
              </svg>
            </div>
            <span class="text-lg font-medium text-gray-900">Loyalty program</span>
          </div>

          <!-- Amount Display -->
          <div class="mb-4">
            <div class="flex flex-col">
              <span class="text-2xl font-bold text-[#2019CE]">$8,900</span>
              <span class="text-sm text-gray-500">Forevers Rent %</span>
            </div>
          </div>

          <!-- History Button -->
          <button @click="navigateToTransactions" class="w-full bg-[#2019CE] hover:bg-[#1814b8] text-white py-2 px-4 rounded-lg transition-all">
            Rent Out History
          </button>
        </div>
      </div>
      ...
      <div class="mb-6">
        <div class="bg-white rounded-2xl p-5 border border-gray-200 shadow-md">
          ...
          <div class="flex items-center space-x-3 mb-4">
            ...
            <span class="text-lg font-medium text-gray-900">Bonus</span>
          </div>

          <!-- Amount Display -->
          <div>
            <div class="flex flex-col">
              <span class="text-2xl font-bold text-[#2019CE]">$56,200</span>
