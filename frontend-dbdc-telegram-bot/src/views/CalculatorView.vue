      ...
      <div class="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 max-w-sm sm:max-w-md mx-auto">
        ...
        <div class="mb-6">
          ...
          <div class="flex gap-2 mb-6">
            <!-- Amount Input -->
            <div class="flex items-center bg-dbd-off-white border border-gray-300 rounded-full px-3 py-2 flex-1">
              <svg class="w-6 h-6 mr-2 text-dbd-gray" viewBox="0 0 24 24" fill="currentColor">
              ...
              <input 
                ...
                type="number" 
                placeholder="50" 
                class="bg-transparent outline-none text-dbd-gray font-medium flex-1"
              />
            </div>
            ...
            <div class="relative">
              <button 
                ...
                class="flex items-center bg-white border border-gray-300 rounded-full px-4 py-2 gap-2 hover:bg-gray-50 transition-colors"
              >
                <div class="flex items-center gap-1">
                  <div class="w-6 h-6 rounded-full overflow-hidden flex-shrink-0">
                    <img src="https://flagcdn.com/w40/ae.png" alt="UAE" class="w-full h-full object-cover" />
                  </div>
                  <svg class="w-3 h-3 text-dbd-dark" viewBox="0 0 14 14" fill="currentColor">
                  ...
                  <span class="text-sm font-medium text-dbd-dark">UAE</span>
                  <span class="text-gray-400">/</span>
                  <span class="text-sm font-medium text-dbd-primary">9 USD</span>
                </div>
                <svg class="w-4 h-4 text-gray-400 ml-1" :class="{ 'rotate-180': showCurrencyDropdown }" viewBox="0 0 16 16" fill="none">
                  <path d="M4.7998 6.4001L7.9998 9.6001L11.1998 6.4001" stroke="currentColor" stroke-width="0.8" stroke-linecap="round"/>
                </svg>
              </button>

              <!-- Currency Dropdown -->
              <div v-if="showCurrencyDropdown" class="absolute top-full mt-1 left-0 w-64 bg-gradient-to-r from-purple-800 to-purple-900 rounded-xl shadow-xl border border-purple-600 z-50 p-2 max-h-80 overflow-y-auto">
                <div v-for="currency in currencies" :key="currency.code" 
                  ...
                  <div class="flex items-center gap-2">
                    <div class="w-6 h-6 rounded-full overflow-hidden">
                      <img :src="currency.flag" :alt="currency.name" class="w-full h-full object-cover" />
                    </div>
          ...
          <div class="bg-dbd-light-blue border border-purple-200 rounded-2xl p-4 mb-6">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 bg-white border border-purple-300 rounded-full flex items-center justify-center">
              ...
              <div class="flex-1">
                <div class="text-sm text-dbd-gray">
                  <span class="text-red-500">Invested</span>
                  <span> in Forevers UAE</span>
                </div>
              </div>
              <div class="text-right">
                <div class="text-lg font-bold text-dbd-dark">{{ calculatedInvestment }} USD</div>
              </div>
            </div>
          </div>
          ...
          <div class="mb-6">
            <div class="flex items-center gap-3 mb-4">
              <div class="w-10 h-10 bg-white border border-dbd-primary rounded-full flex items-center justify-center">
                <svg class="w-6 h-6 text-dbd-primary" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="space-y-2">
              ...
              <div class="bg-dbd-light-blue rounded-2xl p-4 relative">
                <div class="flex items-center gap-3">
                  ...
                  <button class="w-6 h-6 bg-white border border-gray-300 rounded-full flex items-center justify-center hover:bg-gray-50">
                ...
                <div class="border-t border-white mt-3 pt-3">
                  <div class="text-center text-lg font-bold text-dbd-dark">{{ bankDepositReturn }} USD</div>
                </div>
              </div>
              ...
              <div class="bg-dbd-light-blue rounded-2xl p-4 relative">
                ...
                <div class="border-t border-white mt-3 pt-3">
                  <div class="text-center text-lg font-bold text-dbd-dark">{{ residentialReturn }} USD</div>
                </div>
              </div>
              ...
              <div class="bg-dbd-light-blue rounded-2xl p-4 relative">
                ...
                <div class="border-t border-white mt-3 pt-3">
                  <div class="text-center text-lg font-bold text-dbd-dark">{{ commercialReturn }} USD</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-dbd-light-blue border border-purple-200 rounded-xl p-4 mt-6">
          <h3 class="text-center text-xl font-bold mb-3">
            <span class="text-dbd-primary">Forevers UAE</span>: A Smarter
            <span class="text-red-500"> Investment</span> Opportunity
          </h3>
          
          <!-- Placeholder for logo/icon -->
          <div class="w-22 h-22 mx-auto my-4 bg-gray-200 rounded-full"></div>
          
          <p class="text-center text-dbd-dark mb-4">
...
.hover\:from-purple-700:hover {
  --tw-gradient-from: rgb(126 34 206);
}
