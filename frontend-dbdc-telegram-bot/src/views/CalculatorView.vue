      ...
      <div class="bg-white rounded-3xl border border-gray-200 shadow-sm px-6 py-3 max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto relative">
        ...
        <div class="mb-6">
          ...
          <div class="flex gap-2 mb-6">
            <!-- Amount Input -->
            <div class="flex items-center bg-dbd-off-white border border-gray-200 rounded-full px-3 py-2.5 flex-1 max-w-[140px] sm:max-w-none sm:flex-1">
            ...
            <div class="relative flex-shrink-0">
              <button
                ...
                class="flex items-center bg-white border border-gray-200 rounded-full px-2 sm:px-3 py-2.5 gap-1 sm:gap-2 hover:bg-gray-50 transition-colors min-w-fit text-xs sm:text-sm"
              >
                <div class="flex items-center gap-1 sm:gap-1.5">
                  <CountryFlag :country="selectedCurrency.country" size="small" class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" />
                  <svg class="w-3 h-3 sm:w-3.5 sm:h-3.5 text-dbd-dark flex-shrink-0" viewBox="0 0 14 14" fill="currentColor">
                  ...
                  <span class="text-xs sm:text-sm font-medium text-dbd-dark">{{ selectedCurrency.code }}</span>
