        ...
        <div class="mb-6">
          ...
          <div class="flex gap-2 mb-6">
            ...
            <div class="relative w-[180px] sm:flex-shrink-0 sm:min-w-[140px] sm:w-auto">
              ...
              <!-- Currency Dropdown -->
              <div v-if="showCurrencyDropdown" class="absolute top-full mt-1 right-0 w-64 bg-gradient-to-r from-purple-800 via-purple-900 to-purple-900 rounded-xl shadow-xl border border-purple-600 z-50 p-2 max-h-80 overflow-y-auto scrollbar-hide whitespace-nowrap">
