      ...
      <div class="bg-white rounded-3xl border border-gray-200 shadow-sm px-6 py-3 max-w-sm mx-auto relative">
        ...
        <div class="mb-6">
          ...
          <div class="flex gap-2 mb-6">
            <!-- Amount Input -->
            <div class="flex items-center bg-dbd-off-white border border-gray-200 rounded-full px-3 py-2.5 flex-1">
              <svg class="w-6 h-6 mr-2 text-dbd-gray flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              <input 
                ...
                type="number" 
                placeholder="50" 
                class="bg-transparent outline-none text-dbd-gray font-medium flex-1 min-w-0"
              />
            </div>
            ...
            <div class="relative">
              <button 
                ...
                class="flex items-center bg-white border border-gray-200 rounded-full px-3 py-2.5 gap-2 hover:bg-gray-50 transition-colors min-w-fit"
              >
                <div class="flex items-center gap-1.5">
                  <div class="w-6 h-6 rounded-full overflow-hidden flex-shrink-0">
                    <img :src="selectedCurrency.flag" :alt="selectedCurrency.name" class="w-full h-full object-cover" />
                  </div>
              ...
              <!-- Currency Dropdown -->
              <div v-if="showCurrencyDropdown" class="absolute top-full mt-1 left-0 w-64 bg-gradient-to-r from-purple-800 via-purple-900 to-purple-900 rounded-xl shadow-xl border border-purple-600 z-50 p-2 max-h-80 overflow-y-auto">
            ...
            <div class="space-y-2">
              ...
              <div class="bg-dbd-light-blue rounded-2xl p-4 relative">
                <div class="flex items-center gap-3">
                  ...
                  <button class="w-6 h-6 bg-white border border-gray-300 rounded-full flex items-center justify-center hover:bg-gray-50 flex-shrink-0">
