      ...
      <div class="bg-white rounded-3xl border border-gray-200 shadow-sm px-4 sm:px-6 py-6 w-[96%] mx-auto relative">
        ...
        <div class="mb-6">
          ...
          <div class="flex gap-2 mb-6">
            <!-- Amount Input -->
            <div class="flex items-center bg-dbd-off-white border border-gray-200 rounded-full px-2 sm:px-3 py-2.5 h-11 w-1/2 sm:flex-1 min-w-0">
            ...
            <!-- Currency Selector -->
            <div class="relative w-1/2 sm:flex-shrink-0 sm:min-w-[140px] sm:w-auto">
              <button
                @click="toggleCurrencyDropdown"
                class="flex items-center bg-white border border-gray-200 rounded-full px-2 sm:px-3 py-2.5 h-11 gap-1 sm:gap-2 hover:bg-gray-50 transition-colors min-w-fit text-xs sm:text-sm justify-start"
              >
