            ...
            <div class="space-y-6">
              ...
              <div class="relative">
                <div :class="[
                  ...
                  <div v-if="showEmailFilled" class="w-5 h-5 rounded-full border border-[#E0E0E0] bg-white hover:bg-gray-50 flex items-center justify-center cursor-pointer ml-2" @click="editField('email')" title="Edit email">
                    <svg class="w-3 h-3" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="relative">
                <div :class="[
                  ...
                  <div v-if="showFirstNameFilled" class="w-5 h-5 rounded-full border border-[#E0E0E0] bg-white hover:bg-gray-50 flex items-center justify-center cursor-pointer ml-2" @click="editField('firstName')" title="Edit first name">
                    <svg class="w-3 h-3" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                    </svg>
                  </div>
              ...
              <div class="relative">
                <div :class="[
                  ...
                  <div v-if="showLastNameFilled" class="w-5 h-5 rounded-full border border-[#E0E0E0] bg-white hover:bg-gray-50 flex items-center justify-center cursor-pointer ml-2" @click="editField('lastName')" title="Edit last name">
                    <svg class="w-3 h-3" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                    </svg>
                  </div>
              ...
              <div class="relative country-dropdown-container">
                <div :class="[
                  ...
                  <div v-else class="flex items-center flex-1">
                    ...
                    <div v-if="showCountryFilled" class="w-5 h-5 rounded-full border border-[#E0E0E0] bg-white hover:bg-gray-50 flex items-center justify-center cursor-pointer mr-2" @click="editField('country')" title="Edit country">
                      <svg class="w-3 h-3" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                      </svg>
                    </div>
              ...
              <div class="relative">
                <div :class="[
                  ...
                  <div v-else class="flex items-center flex-1">
                    ...
                    <div v-if="showPhoneFilled" class="w-5 h-5 rounded-full border border-[#E0E0E0] bg-white hover:bg-gray-50 flex items-center justify-center cursor-pointer mr-2" @click="editField('phone')" title="Edit phone number">
                      <svg class="w-3 h-3" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                      </svg>
                    </div>
