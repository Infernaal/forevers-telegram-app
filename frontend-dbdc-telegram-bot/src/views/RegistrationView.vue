        ...
        <div class="w-full rounded-3xl bg-gradient-to-r from-dbd-primary to-[#473FFF] relative overflow-hidden">
          ...
          <div class="relative p-4 pb-8">
            ...
            <div class="space-y-2">
              ...
              <!-- Your Partner Section (показывается только для реферальных пользователей) -->
              <div v-if="isReferralUser" class="mt-4">
                <div class="w-full h-12 rounded-lg bg-white bg-opacity-50 flex items-center px-3">
                  <div class="flex items-center gap-2">
                    <!-- User icon -->
                    <div class="flex items-center justify-center w-6 h-6 p-[1px]">
                      <svg class="w-[18px] h-[22px]" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 22">
                  ...
                  <div class="ml-auto text-right">
                    <div class="text-white text-base font-medium leading-5">Jason Statham</div>
                    <div class="text-dbd-primary text-sm font-semibold leading-4 underline underline-offset-auto">User ID: {{ referralUserId }}</div>
                  </div>
                </div>
              </div>
