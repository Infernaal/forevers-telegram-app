            ...
            <div class="space-y-2">
              ...
              <div v-if="referralInfo && referralInfo.isReferral" class="relative">
                <div class="w-full h-12 rounded-lg bg-white bg-opacity-50 relative">
                  ...
                  <div class="absolute right-3 top-1 text-right">
                    <!-- Partner name (if available) -->
                    <div v-if="referralInfo.firstName && referralInfo.lastName" class="text-white text-base font-medium leading-5">
                      {{ referralInfo.firstName }} {{ referralInfo.lastName }}
                    </div>

                    <!-- User ID -->
                    <div class="text-white text-sm leading-4" :class="referralInfo.firstName && referralInfo.lastName ? 'mt-1' : 'text-base font-medium leading-5'">
