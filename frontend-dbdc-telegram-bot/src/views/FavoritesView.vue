    ...
    <main class="flex-1 w-full px-4 sm:px-6 md:px-8 lg:px-12 pt-4 sm:pt-6 md:pt-8 lg:pt-10 pb-4 sm:pb-6 md:pb-8 lg:pb-10 flex flex-col">
      ...
      <div class="bg-purple-50 border border-purple-200 rounded-2xl lg:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-6 mb-4 sm:mb-6 md:mb-8 lg:mb-6 flex-shrink-0">
        <div class="flex items-start justify-between mb-4 lg:mb-6">
          <h2 class="text-2xl lg:text-4xl font-semibold text-black leading-7 lg:leading-tight">
            Forevers<br>Balance
          </h2>
      ...
      <!-- Scroll Content -->
      <div class="flex-1 overflow-y-auto pt-4 sm:pt-6 md:pt-8 lg:pt-8 pb-24 sm:pb-28 md:pb-32 lg:pb-36 space-y-4 sm:space-y-6 md:space-y-8 lg:space-y-8" v-if="balances.length > 0">
        <div
        ...
        >
          ...
          <div class="flex items-center gap-1 lg:gap-3 mb-3 lg:mb-6 flex-wrap">
            ...
            <div class="flex items-center gap-0.5 lg:gap-2 text-sm lg:text-base text-gray-600 font-medium">
              <span>1</span>
              <svg width="16" height="16" viewBox="0 0 16 16" class="text-gray-600 lg:w-6 lg:h-6">
            ...
            <div
              :class="[
                'px-2 lg:px-4 py-0.5 lg:py-2 rounded lg:rounded-lg text-xs lg:text-base font-semibold flex items-center gap-1 lg:gap-2 ml-1 lg:ml-2',
                balance.priceChange > 0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
              ]"
            >
              <svg
                :class="[
                  'w-2 h-2 lg:w-4 lg:h-4 transform',
