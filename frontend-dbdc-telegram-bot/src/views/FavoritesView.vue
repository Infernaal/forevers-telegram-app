    ...
    <div class="flex-1 w-full overflow-y-auto px-4 pb-32" v-if="balances.length > 0">
      <div class="space-y-4">
        ...
        >
          ...
          <!-- Available + Discount Section (one row) -->
          <div class="flex flex-col sm:flex-row gap-2 mb-3">
            <!-- Available -->
            <div class="flex-1 bg-green-100 rounded-xl p-3 flex items-center justify-between">
              <div class="flex items-center gap-2">
            ...
            <div
              ...
              class="bg-red-100 rounded-xl p-3 flex flex-col items-center justify-center w-full sm:w-[12rem] text-center"
            >
