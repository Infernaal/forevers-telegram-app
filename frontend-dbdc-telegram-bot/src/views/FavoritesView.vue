<template>
  <div class="h-screen bg-gray-100 flex flex-col font-sans overflow-hidden">
    <!-- Main Content -->
    <main class="flex-1 w-full max-w-md lg:max-w-6xl xl:max-w-7xl mx-auto px-3.5 lg:px-12 xl:px-16 pt-4 lg:pt-8 xl:pt-12 pb-2 lg:pb-6 flex flex-col">
      <!-- Total Balance Card -->
      ...
      <!-- Scroll Content -->
      <div class="flex-1 overflow-y-auto pt-2 lg:pt-6 xl:pt-8 pb-24 lg:pb-32 xl:pb-40 space-y-2 lg:space-y-4 xl:space-y-6" v-if="balances.length > 0">
        <div
