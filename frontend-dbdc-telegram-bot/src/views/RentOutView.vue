      ...
      <div class="space-y-4 lg:space-y-8">
        ...
        >
          ...
          <div class="flex items-center gap-1 lg:gap-3 mb-3 lg:mb-8">
            ...
            <div
              class="flex items-center gap-1 lg:gap-3 px-2 lg:px-6 py-0.5 lg:py-3 rounded font-semibold text-xs lg:text-xl"
          ...
          <div class="bg-green-100 rounded-xl lg:rounded-3xl p-3 lg:p-8 flex items-center justify-between">
            <div class="flex items-center gap-1 lg:gap-3">
              ...
              <div class="flex items-center gap-1 lg:gap-3">
                ...
                <span class="text-sm lg:text-2xl font-medium text-dbd-dark">{{ item.availableAmount }}</span>
              </div>
            </div>

            <button
              @click="showInfoTooltip = true"
              class="w-6 h-6 lg:w-16 lg:h-16 border border-gray-300 bg-white rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors"
            >
              <svg class="text-dbd-gray w-5 h-5 lg:w-12 lg:h-12" viewBox="0 0 20 20">
