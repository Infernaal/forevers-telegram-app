...
import { _ as g, B as y, w as $ } from "./index-BtCfIIfO.js";
import { T as R, h as A } from "./should-force-browser-runtime-in-node-ikxWrCvn.js";
import { a as v, g as S } from "./get-block-properties-4dl07r5f.js";
const L = () => import("./awaiter-vsM2I4ci.js").then((e) => e.default).catch((e) => {
  throw console.error(
    "Error while attempting to dynamically import component Awaiter at ../../awaiter.vue",
    e
  ), e;
}), I = () => import("./live-edit-dkMPrQFh.js").then((e) => e.default).catch((e) => {
  throw console.error(
